...
console.log('Recipes added to document');
}
...
console.log('Checking local storage for recipes...');
...
console.log('No recipes found in local storage. Fetching from network...');
...
console.log('Recipes saved to storage');
}
...
if (!recipes) {
  console.log('No recipes to add to document');
  return;
}
...
recipes.forEach((recipe) => {
  ...
  console.log('Recipe card added:', recipeCard);
});
}
